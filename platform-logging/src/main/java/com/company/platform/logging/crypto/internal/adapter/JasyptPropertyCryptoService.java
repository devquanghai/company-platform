package com.company.platform.logging.crypto.internal.adapter;
    ...
    public String encrypt(String plainText) {
        ...
        try {
            ...
            throw new PlatformCryptoException(
                "PROPERTY.ENCRYPTION.FAILED", "Property encryption failed");
        }
    }
    ...
    public String decrypt(String encryptedText) {
        ...
        try {
            ...
            LOG.debug("property_crypto_finished operation=DECRYPT provider=JASYPT outcome=FAILED error_type={}",
                failure.getClass().getSimpleName());
            throw new PlatformCryptoException(
                "PROPERTY.DECRYPTION.FAILED", "Property decryption failed");
        }
    }
