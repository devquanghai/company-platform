...
The child contains no hard-coded dependency version. Jasypt remains an
extension-only provider until a compatible version is deliberately pinned in
the root dependency management.
