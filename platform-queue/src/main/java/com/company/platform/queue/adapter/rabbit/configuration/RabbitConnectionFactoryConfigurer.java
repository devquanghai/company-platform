package com.company.platform.queue.adapter.rabbit.configuration;
...
public final class RabbitConnectionFactoryConfigurer {
    ...
    public static CachingConnectionFactory create(
        ...
        configureTls(client, rabbit.getSsl());
    ...
    private static void configureTls(
        com.rabbitmq.client.ConnectionFactory client, SslProperties ssl
    ) {
        if (!ssl.isEnabled()) {
            return;
        }
